<template>
  ...
  export default {
    data() {
      ...
      <!-- 分割线 -->
      <div v-show="compareVersion('SJGS')">
        <h3 id="SJGS">{{getNav('SJGS').name}}</h3>
        <y-card :split="2">
          <div slot="card1" class="preview-card">
            <div class="preview">
              <p>hh时</p>
            ...
            <div class="introduce">
              设置属性
              <code>format</code>可以改变时间的显示格式，但实际的值不会同样变化。
            </div>
          </div>

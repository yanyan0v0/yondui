<template>
  <div class="y-loading-timer" :style="{'border-color': color}">
    <span class="y-loading-timer-hour" :style="style"></span>
    <span class="y-loading-timer-minute" :style="style"></span>
  </div>
</template>
...
.y-loading-timer .y-loading-timer-hour,
